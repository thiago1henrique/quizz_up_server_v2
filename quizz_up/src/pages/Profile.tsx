        ...
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
            ...
            <div className="max-w-4xl mx-auto px-4 py-32">
                ...
                <div className="text-center mt-8 space-y-4 sm:space-y-0 sm:flex sm:justify-center sm:gap-4">
                    ...
                    <button
                        onClick={handleLogout}
                        className="cursor-pointer inline-flex items-center mt-4 px-6 py-3 bg-red-500 text-white font-medium rounded-lg shadow-md hover:bg-red-600 transition-all transform hover:scale-105 w-full sm:w-auto"
                    >
                        <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
